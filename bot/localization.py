LANGUAGES = {
    'en': {
        ...
        'choose_crypto_method': 'How would you like to pay for {item} ({price}€)?',
        ...
        'promo_already_applied': '⚠️ A promo code is already applied to this purchase.',
        'purchase_invoice_hint': 'After paying, press "Check payment" to receive {item}.',
        'purchase_refunded': '❌ Item out of stock. {amount}€ has been returned to your balance.',
    ...
    'ru': {
        ...
        'choose_crypto_method': 'Как оплатить {item} за {price}€?',
        ...
        'promo_already_applied': '⚠️ Промокод уже применён к этой покупке.',
        'purchase_invoice_hint': 'После оплаты нажмите «Проверить оплату», чтобы получить {item}.',
        'purchase_refunded': '❌ Товар закончился. {amount}€ возвращены на ваш баланс.',
    ...
    'lt': {
        ...
        'pay_with_balance': 'Apmokėti iš balanso',
        'pay_with_crypto': 'Apmokėti kriptovaliuta',
        'choose_crypto_method': 'Kaip norite apmokėti {item} ({price}€)?',
        ...
        'promo_already_applied': '⚠️ Nuolaidos kodas jau pritaikytas šiam pirkiniui.',
        'purchase_invoice_hint': 'Po apmokėjimo paspauskite „Patikrinti mokėjimą“, kad gautumėte {item}.',
        'purchase_refunded': '❌ Prekės nebeliko. {amount}€ grąžinta į jūsų balansą.',
